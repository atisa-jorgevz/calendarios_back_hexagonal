<<<<<<< HEAD:app/interfaces/api/v1/endpoints/cliente_proceso_hito.py
...
def get_hitos_por_proceso(
    ...
    return hitos
>>>>>>> 4f351415dd363130ef65dd51fd1f435b47d5ff0a:app/infrastructure/api/v1/endpoints/cliente_proceso_hito.py
