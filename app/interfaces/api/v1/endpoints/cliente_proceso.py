<<<<<<< HEAD:app/interfaces/api/v1/endpoints/cliente_proceso.py
...
def delete(id: int, repo = Depends(get_repo)):
    ...
    if not ok:
        raise HTTPException(status_code=404, detail="No encontrado")
    return {"mensaje": "Eliminado"}
>>>>>>> 4f351415dd363130ef65dd51fd1f435b47d5ff0a:app/infrastructure/api/v1/endpoints/cliente_proceso.py
